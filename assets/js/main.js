...
sr.reveal('.about__text', {delay: 125})
sr.reveal('.about__social-icon', {delay: 150, interval: 200})

/*SCROLL SKILLS*/
sr.reveal('.skills__subtitle', {})
sr.reveal('.skills__name', {distance: '20px', delay: 25, interval: 100})
sr.reveal('.skills__img', {delay: 100})

/*SCROLL PORTFOLIO*/
sr.reveal('.portfolio__img', {interval: 75})

/*SCROLL CONTACT*/
sr.reveal('.contact__subtitle', {})
sr.reveal('.contact__text', {interval: 150})
